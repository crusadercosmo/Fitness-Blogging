...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="bg-light p-4 rounded-lg text-black text-center">
            <h1><?php echo $q['title'];?></h1>

            <div class="d-flex mt-2 justify-content-center align-items-center " style="color: white ;">
        ...
        <p class="mt-5 border-left border-white pl-3 text-white"><?php echo $q['content'];?></p>
        <?php } ?>
        <center><a href="index.php" class="btn btn-outline-light my-3">Go Home</a></center>
