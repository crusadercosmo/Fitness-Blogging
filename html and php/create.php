...
<body>
   ...
   <div class="container mt-5 mb-5" style="width: 50vw ; border:2px solid grey; border-radius:10px;">
        <form method="POST">
            <input type="text" placeholder="Blog Title" class="form-control my-3 bg-light text-black text-center" name="title">
            <textarea name="content" class="form-control my-3 bg-light text-black" cols="30" rows="13"></textarea>
            <center><button class="btn btn-light" name="new_post">Add Post</button></center>
            <br>
